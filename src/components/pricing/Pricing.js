...
const hobbyFeatures = [
  ...
  "Free logo design w/unlimited revisions",
  "Unlimited website revisions",
];
const scaleFeatures = [
  "Mobile applications",
  "Social media campaigns with Facebook, Instagram, and more",
  "Blog Posts, Email marketing",
  "Managed social media accounts and more!",
];
const growthFeatures = [
  "Unlimited products",
  "Full admin dashboard w/ site analytics",
  "Database for users and up to 5 staff accounts",
                  ...
                  <div className="flex-1 flex flex-col">
                    <div className="bg-white px-6 py-10">
                      <div>
                        ...
                        <h3
                          className="text-center text-1xl font-medium text-gray-500"
                          id="tier-hobby"
                        >
                          Set up cost $199
                        </h3>
                ...
                <div className="relative z-10 rounded-lg shadow-xl">
                  ...
                  <div className="bg-white rounded-t-lg px-6 pt-12 pb-10">
                    <div>
                      ...
                      <h3
                        className="text-center text-1xl font-semibold text-gray-500 sm:-mx-6"
                        id="tier-growth"
                      >
                        Set up cost $499
                      </h3>
                  ...
                  <div className="flex-1 flex flex-col">
                    <div className="bg-white px-6 py-10">
                      <div>
                        ...
                        <div className="mt-4 flex items-center justify-center">
                          <span className="px-3 flex items-start text-3xl tracking-tight text-gray-900">
